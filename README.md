...
**NOTICE:** This plugin branch is for PocketMine-MP 4. If you are looking for the PocketMine-MP 3 version of this plugin, please visit the [main](https://github.com/thebigcrafter/KygekEatHeal/tree/main) branch.
...
- Join our Discord server [here](https://discord.gg/cEXW8uK6QA) for latest updates from KygekTeam.
- If you found bugs or want to give suggestions, please visit [here](https://github.com/thebigcrafter/KygekEatHeal/issues) or join our Discord server.
- We accept all contributions! If you want to contribute please make a pull request in [here](https://github.com/thebigcrafter/KygekEatHeal/pulls).
